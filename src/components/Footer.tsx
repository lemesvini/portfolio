    ...
    <footer className="py-12 relative">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center">
          ...
          >
            <a href="https://github.com/devine-org" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
          ...
          >
            ...
            <p className="mt-1">Open source collective by João, Higor, and Vini.</p>
          </motion.div>
        </div>
      </div>
    </footer>
